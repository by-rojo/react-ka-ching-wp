			...
			<h2 style="font-size: 22px;">Test Configuration</h2>
				...
				<div class="mo_api_authentication_support_layout" style="width: 90%;">
					...
					<table>
						...
						<tr>
							<!-- <td><b> GET </b></td> -->
							<td><input type='button' value="GET" class='mo_test_config_request_method'>&nbsp;<input type='text' id='rest_endpoint_jwt_auth' value="<?php echo get_rest_url() . 'wp/v2/posts'; ?>" size="40" class='mo_test_config_input' placeholder='Enter REST API Endpoint' /></td>
						</tr>
						<tr>
							<td>
								<p>Token:</p>

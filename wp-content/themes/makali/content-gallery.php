		...
		<div class="post-info"> 
			...
			<?php else : ?>
				...
				<div class="entry-summary">
					<div>
						<?php $length_makali = '20';
						if(isset($makali_opt['excerpt_length']) && $makali_opt['excerpt_length'] != '')  {
							$length_makali = $makali_opt['excerpt_length'];
						}
						echo Makali_Class::makali_excerpt_by_id($post->ID, $length = $length_makali); ?>
					</div>

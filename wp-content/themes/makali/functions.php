...
Class Makali_Class {
	...
	*/
	...
	static function makali_post_thumbnail_size($size){
		...
		if($size!=''){
			...
			$wp_session["makali_postthumb"] = 'makali-post-thumb';
		}
	...
	*/
	...
	function makali_woo_related_products_limit( $args ) {
		global $product;
		$makali_opt = get_option( 'makali_opt' );
		if(isset($makali_opt['related_amount'])) {
	...
	function makali_scripts_styles() {
		...
		*/
		...
		if ( is_singular( 'product' ) ) {
			wp_enqueue_script( 'magnifier-js', get_template_directory_uri() . '/js/jquery.carouFredSel.min.js', array('jquery'), '6.2.1', true );
		}
		//Add Shuffle js
		...
		if(isset($makali_opt['enable_less'])){
			if($makali_opt['enable_less']){
				...
				switch ($presetopt) {
					...
					break;
					// for Cosmetic 07
					case $presetopt == 86 || $presetopt == 87 || $presetopt == 88:
						$themevariables['body_font'] = 'Open Sans';
						$themevariables['heading_font'] = 'Open Sans';
						$themevariables['menu_font'] = 'Open Sans';
						$themevariables['sub_menu_font'] = 'Open Sans';
						$themevariables['dropdown_font'] = 'Open Sans';
						$themevariables['categories_font'] = 'Open Sans';
						$themevariables['categories_sub_menu_font'] = 'Open Sans';
						$themevariables['price_font'] = 'Open Sans';
						$themevariables['price_font_size'] = '15px';
						$themevariables['row_container'] = '1440px';
						$themevariables['row_space'] = '60px';
						
						$themevariables['text_color'] = '#666666';
						$themevariables['primary_color'] = '#c0b07d';
						$themevariables['menu_color'] = '#253237';
						$themevariables['menu_font_weight'] = '700';
						$themevariables['menu_hover_itemlevel1_color'] = '#c0b07d';
						$themevariables['header_sticky_bg'] = 'rgba(255, 255, 255, 0.9)';
						$themevariables['link_hover_color'] = '#c0b07d';
						$themevariables['link_active_color'] = '#c0b07d';
						$themevariables['sale_color'] = '#cf2929';
						$themevariables['saletext_color'] = '#ffffff';
						$themevariables['rate_color'] = '#fdd835';
						
						$themevariables['topbar_bg'] = '#253237';
						$themevariables['topbar_color'] = '#ffffff';
						$themevariables['topbar_link_color'] = '#ffffff';
						$themevariables['topbar_link_hover_color'] = '#c0b07d';
						$themevariables['topbar_link_active_color'] = '#c0b07d';
						$themevariables['header_bg'] = '#ffffff';
						$themevariables['header_color'] = '#253237';
						$themevariables['header_link_color'] = '#253237';
						$themevariables['header_link_hover_color'] = '#c0b07d';
						$themevariables['header_link_active_color'] = '#c0b07d';

						$themevariables['footer_bg'] = '#f6f6f6';
						$themevariables['bg_btn_mc4wp'] = '#323232';
						$themevariables['bg_h_btn_mc4wp'] = '#c0b07d';
						$themevariables['color_btn_mc4wp'] = '#ffffff';
						$themevariables['color_h_btn_mc4wp'] = '#ffffff';
						$themevariables['footer_title_color'] = '#253237';
						$themevariables['footer_color'] = '#666666';
						$themevariables['footer_link_color'] = '#666666';
						$themevariables['footer_link_hover_color'] = '#c0b07d';
						$themevariables['footer_link_active_color'] = '#c0b07d';
					break;
					case $presetopt == 89:
						$themevariables['body_font'] = 'Open Sans';
						$themevariables['heading_font'] = 'Open Sans';
						...
						$themevariables['menu_font_weight'] = '700';
						$themevariables['menu_hover_itemlevel1_color'] = '#ffffff';
						$themevariables['header_sticky_bg'] = 'rgba(192, 176, 125, 0.9)';
						$themevariables['link_hover_color'] = '#c0b07d';
						$themevariables['link_active_color'] = '#c0b07d';
						$themevariables['sale_color'] = '#cf2929';
						$themevariables['saletext_color'] = '#ffffff';
		...
		wp_enqueue_style( 'makali-css-theme', get_template_directory_uri() . '/css/theme'.$presetopt.'.css', array('bootstrap-css'), time() );
	...
	*/
	...
	function makali_get_font_url() {
		...
		* supported by Libre Franklin, Playfair Display, Open Sans translate this to 'off'. Do not translate
		...
		*/
		...
		$open_sans = _x( 'on', 'Open Sans font: on or off', 'makali' );
		if ( 'off' !== $libre_franklin || 'off' !== $playfair_display || 'off' !== $open_sans) {
			$font_families = array();
...
function makali_sale_percentage() {
   global $product;
   $sale_per = "";
   $max_percentage = "";
   $percentage = "";
   ...
   if ( $max_percentage > 0 ) $sale_per = "<span class='onsale'>-" . round($max_percentage) . "%</span>";
   return $sale_per;
}

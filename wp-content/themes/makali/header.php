...
<meta name="p:domain_verify" content="1fba0912394055bccaeaa1b065861c3a"/>
<?php wp_head(); ?>
...
<body <?php body_class(); ?>>
	<div class="wrapper <?php if(isset($makali_opt['page_layout']) && $makali_opt['page_layout']=='box'){echo 'box-layout';}?> <?php if(isset($makali_opt['page_layout']) && $makali_opt['page_layout']=='box_body'){echo 'box-body';}?>">
	<div class="page-wrapper">
		...
		<?php if(isset($makali_opt['page_layout']) && $makali_opt['page_layout']=='box_body') { ?>

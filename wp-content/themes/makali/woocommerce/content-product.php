	...
	<div class="product-wrapper gridview">
		...
		<div class="list-col8">
			<div class="stock-status">
				...
				?>
				<a href="<?php the_permalink(); ?>"><?php echo ''.$stock_status; ?></a>
			</div>
			...
			<?php if ( $product->get_price() != '' )  { ?>
				<div class="price-box">
					<div class="price-box-inner">
						...
						<?php echo makali_sale_percentage(); ?>
					</div>
				</div>
			<?php } ?>
			<!-- end price -->
			...
			<div class="count-down">
				<div class="txt-hurryup">
					<p><?php esc_html_e('Hurry Up!', 'makali');?></p>
					<p><?php esc_html_e('Offer ends in:', 'makali');?></p>
				</div>
				<?php
				$countdown = false;
				$sale_end = get_post_meta( $product->get_id(), '_sale_price_dates_to', true );
